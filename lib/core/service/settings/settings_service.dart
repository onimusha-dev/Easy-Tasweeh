  ...
  SettingsState loadSettings() {
    return SettingsState(
      ...
      reminders: ReminderSettings(
        ...
        afterSalahFajrTime: _parseTime(prefs.getString('afterSalahFajrTime'), 5, 30),
        ...
        afterSalahMaghribTime: _parseTime(prefs.getString('afterSalahMaghribTime'), 18, 45),
        afterSalahIsha: prefs.getBool('afterSalahIsha') ?? false,
        afterSalahIshaTime: _parseTime(prefs.getString('afterSalahIshaTime'), 20, 0),
      ),
