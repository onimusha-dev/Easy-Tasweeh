...
class SlateRoundedStyle extends StatefulWidget {
  final VoidCallback? onTap;
  final VoidCallback? onTapDown;

  const SlateRoundedStyle({
    super.key,
    this.onTap,
    this.onTapDown,
  });
  ...
  @override
  State<SlateRoundedStyle> createState() => _SlateRoundedStyleState();
}

class _SlateRoundedStyleState extends State<SlateRoundedStyle>
