...
class PurpleOutlinedStyle extends StatefulWidget {
  final VoidCallback? onTap;
  final VoidCallback? onTapDown;

  const PurpleOutlinedStyle({
    super.key,
    this.onTap,
    this.onTapDown,
  });
  ...
  @override
  State<PurpleOutlinedStyle> createState() => _PurpleOutlinedStyleState();
}

class _PurpleOutlinedStyleState extends State<PurpleOutlinedStyle>
