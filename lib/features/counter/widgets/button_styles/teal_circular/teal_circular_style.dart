...
class TealCircularStyle extends StatefulWidget {
  final VoidCallback? onTap;
  final VoidCallback? onTapDown;

  const TealCircularStyle({
    super.key,
    this.onTap,
    this.onTapDown,
  });
  ...
  @override
  State<TealCircularStyle> createState() => _TealCircularStyleState();
}

class _TealCircularStyleState extends State<TealCircularStyle>
